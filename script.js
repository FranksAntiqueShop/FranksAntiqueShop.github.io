            ...
            '$table.find("tr").each(function(idx){' +
                ...
                '$btnMsg.on("click", function(e){' +
                    ...
                    'if (cleanTheme.indexOf("plan") !== -1) {' +
                        'msg = "Thank you for coming! \\r\\n[Plan to save my dear]\\r\\n\\r\\n프랭크의 골동품가게 예약 확정 안내 문자입니다.\\r\\n[https://thefrank.co.kr/layout/res/home.php?go=play] <- 접속링크  꼭 일행 모두가 읽고 오셔야 합니다. \\r\\n\\r\\n성명 : " + name + " 님\\r\\n일시 : " + m + "월 " + d + "일 " + time + "\\r\\n테마 : plan to save my dear\\r\\n[ https://youtu.be/5tDrIq9YVKY?si=2be6UW8HpzEIesqR ] <-를 보고오시면 더더욱 재밌게 즐기실 수 있어요! \\r\\n\\r\\n1. 늦으실 경우 테마 이용시간이 차감될 수 있습니다. (테마 이용시간보다 10분늦으실경우, 플레이가 불가하며, 이로인한 환불은 불가합니다.)\\r\\n* 매장컨셉상, 10분보다 일찍 오실 경우에, 매장 밖에서 대기하셔야 합니다 *\\r\\n\\r\\n2. 매장내 취식이 불가합니다. (간단한 커피,음료포함) 다 드시고 와주시면 감사하겠습니다.\\r\\n \\r\\n3. 인원수가 추가될경우, 게임이 끝난후 결제 도와드리고 있습니다.\\r\\n\\r\\n- 편의시설 안내 \\r\\n 저희 지점은 주차가 어렵습니다. 주변 공영주차장을 이용해 주시면 감사하겠습니다.\\r\\n 매장내에 식수 및 핸드폰 충전기가 제공되지 않습니다. 충분한 수분섭취후 방문 부탁드립니다. \\r\\n\\r\\n- 환불 규정 안내\\r\\n 예약 취소 시 예약금 환불은 받으신 예약번호로 홈페이지를 통해 요청해주시면 됩니다.\\r\\n(단, 예약 당일, 테마시작 24시간 이내 취소 및 예약시간 변경은 예약금 환불이 불가능합니다.)\\r\\n음주상태에서 플레이가 불가능합니다. 이로인한 환불또한 불가합니다.";' +
                    '} else if (cleanTheme.indexOf("private") !== -1 || cleanTheme.indexOf("heaven") !== -1) {' +
                        'msg = "Thank you for coming!\\r\\n[My Private Heaven]\\r\\n\\r\\n프랭크의 골동품가게 예약 확정 안내 문자입니다.\\r\\n***[https://thefrank.co.kr/layout/res/home.php?go=play] <- 접속링크  꼭 일행 모두가 읽고 오셔야 합니다. 꼭 필수 ***********\\r\\n\\r\\n성명 : " + name + " 님\\r\\n일시 : " + m + "월 " + d + "일 " + time + "\\r\\n테마 : My Private Heaven\\r\\n\\r\\n1. 늦으실 경우 테마 이용시간이 차감될 수 있습니다. (테마 이용시간보다 10분 늦으실 경우, 플레이가 불가하며, 이로인한 환불은 불가합니다.)\\r\\n* 매장컨셉상, 10분보다 일찍 오실 경우에, 매장 밖에서 대기하셔야 합니다 *\\r\\n\\r\\n2. 매장 내 취식이 불가합니다. (간단한 커피, 음료 포함) 다 드시고 와주시면 감사하겠습니다.\\r\\n \\r\\n3. 인원수가 추가 될 경우, 대기실에 키오스크를 이용하여 추가결제 하시길 바랍니다. \\r\\n\\r\\n- 편의시설 안내 \\r\\n 저희 지점은 주차가 어렵습니다. 주변 공영주차장을 이용해 주시면 감사하겠습니다.\\r\\n  매장내에 식수 및 핸드폰 충전기가 제공되지 않습니다. 충분한 수분섭취후 방문 부탁드립니다. \\r\\n\\r\\n- 환불 규정 안내\\r\\n 예약 취소 시 예약금 환불은 받으신 예약번호로 홈페이지를 통해 요청해주시면 됩니다.\\r\\n(단, 예약 당일, 테마시작 24시간 이내 취소 및 예약시간 변경은 예약금 환불이 불가능합니다.)\\r\\n음주상태에서 플레이가 불가능합니다. 이로인한 환불또한 불가합니다.";' +
                    '} else {' +
                        'msg = "Thank you for coming!\\r\\n[Brooklyn My Love]\\r\\n\\r\\n프랭크의 골동품가게 예약 확정 안내 문자입니다.\\r\\n***[https://thefrank.co.kr/layout/res/home.php?go=play] <- 접속링크  꼭 일행 모두가 읽고 오셔야 합니다. 꼭 필수 ***********\\r\\n\\r\\n성명 : " + name + " 님\\r\\n일시 : " + m + "월 " + d + "일 " + time + "\\r\\n테마 : Brooklyn My Love\\r\\n\\r\\n1. 늦으실 경우 테마 이용시간이 차감될 수 있습니다. (테마 이용시간보다 10분 늦으실 경우, 플레이가 불가하며, 이로인한 환불은 불가합니다.)\\r\\n* 매장컨셉상, 10분보다 일찍 오실 경우에, 매장 밖에서 대기하셔야 합니다 *\\r\\n\\r\\n2. 매장 내 취식이 불가합니다. (간단한 커피, 음료 포함) 다 드시고 와주시면 감사하겠습니다.\\r\\n \\r\\n3. 인원수가 추가 될 경우, 대기실에 키오스크를 이용하여 추가결제 하시길 바랍니다. \\r\\n\\r\\n- 편의시설 안내 \\r\\n 저희 지점은 주차가 어렵습니다. 주변 공영주차장을 이용해 주시면 감사하겠습니다.\\r\\n 매장내에 식수 및 핸드폰 충전기가 제공되지 않습니다. 충분한 수분섭취후 방문 부탁드립니다. \\r\\n\\r\\n- 환불 규정 안내\\r\\n 예약 취소 시 예약금 환불은 받으신 예약번호로 홈페이지를 통해 요청해주시면 됩니다.\\r\\n(단, 예약 당일, 테마시작 24시간 이내 취소 및 예약시간 변경은 예약금 환불이 불가능합니다.)\\r\\n음주상태에서 플레이가 불가능합니다. 이로인한 환불또한 불가합니다.";' +
                    '}' +
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (reservationInput) {
        reservationInput.addEventListener('keydown', (e) => {
            if (e.key === 'Enter') {
                const keyword = reservationInput.value.trim().replace(/\s+/g, '');
                
                if (keyword === '퇴근하고싶다') {
                    e.preventDefault();
                    const isCottonCandy = document.body.getAttribute('data-theme') === 'cotton-candy';
                    
                    if (!isCottonCandy) {
                        document.body.setAttribute('data-theme', 'cotton-candy');
                        localStorage.setItem('frank_easter_theme', 'cotton-candy');
                        showToast('🏃💨');
                    } else {
                        document.body.removeAttribute('data-theme');
                        localStorage.removeItem('frank_easter_theme');
                        showToast('기본 테마로 변경');
                    }
                    reservationInput.value = '';
                } else if (keyword === '기본' || keyword === '프랭크') {
                    e.preventDefault();
                    document.body.removeAttribute('data-theme');
                    localStorage.removeItem('frank_easter_theme');
                    showToast('기본 테마로 변경');
        ...
        // 새로고침해도 유지
        if (localStorage.getItem('frank_easter_theme') === 'cotton-candy') {
            document.body.setAttribute('data-theme', 'cotton-candy');
        }
    }
});